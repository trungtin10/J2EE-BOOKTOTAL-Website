...
public class AdminProductController {
    ...
    public String addProduct(@Valid @ModelAttribute Product product, BindingResult bindingResult, @RequestParam(name = "imageFile") MultipartFile imageFile, Model model, RedirectAttributes redirectAttributes) {
        ...
        if (imageFile == null || imageFile.isEmpty()) {
            model.addAttribute("errorMessage", "Vui lòng tải lên ảnh bìa sách (JPG, PNG, WebP…).");
            model.addAttribute("categories", productService.getAllCategories());
            model.addAttribute("activePage", "products");
            return "admin/products/product_add";
        }
    ...
    public String deleteProduct(@PathVariable(name = "id") Long id, RedirectAttributes redirectAttributes) {
        ...
        redirectAttributes.addFlashAttribute("successMessage", "Đã xóa mềm sản phẩm thành công");
        return "redirect:/admin/products";
    }
    ...
    public String restoreProduct(@PathVariable(name = "id") Long id, RedirectAttributes redirectAttributes) {
        ...
        redirectAttributes.addFlashAttribute("successMessage", "Khôi phục sản phẩm thành công");
