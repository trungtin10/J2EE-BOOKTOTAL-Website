        ...
        try {
            ...
            String htmlContent = """
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
                    ...
                    <p><b>Mã xác nhận</b> của bạn là:</p>
                    <div style="text-align:center; font-size: 24px; letter-spacing: 6px; font-weight: 800; color: #111; margin: 10px 0 20px;">
                        %s
                    </div>
                    <p>Vui lòng nhấn vào nút bên dưới để đặt lại mật khẩu (Link có hiệu lực trong <b>15 phút</b>):</p>
